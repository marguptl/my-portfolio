...
const Project1 = () => {
  ...
  const projects = [
    { id: 1, title: 'Project 1', image: '/images/gaming1.png' },
    { id: 2, title: 'Project 2', image: '/images/gaming2.png' },
    { id: 3, title: 'Project 3', image: '/images/gaming3.png' },
  ];
    ...
    <>
      ...
      <ProjectPage>
        ...
        <Content>
          ...
          <GitHubLink href="https://gaming-website-seven-dun.vercel.app/" target="_blank" rel="noopener noreferrer">
            View Website
          </GitHubLink>
          <GridPage>
        <GridContainer>
...
const GridContainer = styled.div`
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(390px, 1.5fr));
  gap: 20px;
  width: 100%;
  max-width: 1200px;
`;
